...
Feature: Security
  ...
  Scenario: The edit token is not left visible in the address bar
  ...
  Scenario: The search field safely handles a script-injection payload
  ...
  Scenario: The app response sets baseline transport-security headers
